    ...
    solicitacoes.forEach(solicitacao => {
        tbody.innerHTML += `
            ...
            timeStyle: 'medium'
                   ...
                   <button type="button" id="mensagensBtn" class="btn btn-secondary btn-sm btn-mensagens" data-id="${solicitacao.id}">
                        Mensagens
...
const listarSolicitacaoEmprestimo = document.querySelector('#solicitacao');

if (listarSolicitacaoEmprestimo) {
    listarSolicitacaoEmprestimo.addEventListener('click', abrirModalMensagens);
}
